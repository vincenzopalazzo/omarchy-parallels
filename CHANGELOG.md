...
- Live ISO `omarchy-arm-20260924-aarch64.iso` (sha256 `9ef5e210d731776903fcc32a4c9a6f901a7476065aa77ff431b6d7099f8fef62`). Boots in Parallels arm64 EFI via the hybrid GPT ESP. The live init restores the autologin home and runs `omarchy-provision-user --first-install` before `switch_root`, so the session starts with the Tokyo Night theme, the Quattro wallpaper, and the Omarchy shell instead of an empty skel desktop.
